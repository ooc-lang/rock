...
ArrayType: class extends PointerType {
    ...
    setRef: func (ref: Declaration) {
        Exception new(This, "Trying to set ref of an ArrayType! wtf? ref (" + ref class name + ") = " + ref toString()) throw()
    }
    ...
    toString: func -> String { inner toString() append(expr != null ? "[" + expr toString() + "]" : "[]") }

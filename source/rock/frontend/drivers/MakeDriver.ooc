...
MakeDriver: class extends SequenceDriver {
    ...
    compile: func (module: Module) -> Int {
        ...
        fW write("CFLAGS+=-I %s" cformat(originalOutPath getPath() toCString()))
        ...
        for(currentModule in toCompile) {
            printf("%p, %s\n", currentModule, currentModule fullName toCString())
        ...
        for(currentModule in toCompile) {
            ...
            fW write("\t${CC} ${CFLAGS} -c %s -o %s\n" cformat(cPath toCString(), oPath toCString()))
        }

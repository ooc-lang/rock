...
HostEntry: cover from struct hostent {
  h_name: extern Char* // official name of the host
  h_aliases: extern Char** // alt names
...
getaddrinfo: extern func(nodename: Char*, servname: Char*, hints: AddrInfo*, servinfo: AddrInfo**) -> Int
getnameinfo: extern func(sa: SockAddr*, salen: UInt32, host: Char*, hostlen: SizeT, serv: Char*, servlen: UInt32, flags: Int) -> Int
freeaddrinfo: extern func(ai: AddrInfo*)
gai_strerror: extern func(ecode: Int) -> const Char*
gethostname: extern func(name: Char*, len: SizeT) -> Int
gethostbyname: extern func(name: Char*) -> HostEntry*
gethostbyaddr: extern func(addr: Char*, len: Int, type: Int) -> HostEntry*
...
inet_ntoa: extern func(inaddr: InAddr) -> Char*
inet_aton: extern func(cp: Char*, inp: InAddr*) -> Int
inet_addr: extern func(cp: Char*) -> ULong
inet_ntop: extern func(af: Int, src: Pointer, dst: Char*, size: UInt) -> Char*
inet_pton: extern func(af: Int, src: Char*, dst: Pointer) -> Int
